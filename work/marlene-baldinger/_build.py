...
.minisign{flex:0 0 210px;max-width:210px}
.minisign img{width:100%;height:auto;display:block}
...
@media(max-width:600px){
 ...
 .band2 .runner{width:84px;margin:0 auto}
 ...
 .minisign{margin:0 auto;flex:0 0 200px}
...
RUNNER = '<img class="{cls}" src="assets/runner-{tone}.png" alt="" aria-hidden="true">'
IC = {
...
<header class="site"><div class="wrap brand">
  <a class="lockup" href="index.html" aria-label="Marlene Baldinger home">
    {RUNNER.format(cls="runner",tone="gold")}
    <span class="lines">
...
<div class="band2"><div class="wrap">
 ...
 {RUNNER.format(cls="runner",tone="teal")}
</div></div>
<div class="wrap statsrow">
 <div class="statcell">{RUNNER.format(cls="ic",tone="teal")}<div>
...
<div class="wrap">
 ...
 <div class="signcard">
  <div class="minisign"><img src="assets/yard-sign.png" alt="A Marlene Baldinger campaign yard sign reading Council President, Running for What's Important to You"></div>
