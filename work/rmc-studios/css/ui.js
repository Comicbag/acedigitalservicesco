/* RMC Studios: nav + scroll reveal. No scroll listeners.
...
(function () {
  ...
  // ---- sub menus (touch + keyboard): the arrow button opens the list under a top level item
  Array.prototype.forEach.call(document.querySelectorAll('.subtoggle'), function (b) {
